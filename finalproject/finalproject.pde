...
void room2() {
  ...
  texture(wall2);
  textureWrap(REPEAT);
  vertex(3000/6,height,0,0,0);
  vertex(3000/6,height,-4000,1,0);
  vertex(3000/6,-2000,-4000,1,1);
  vertex(3000/6,-2000,0,0,1);
  endShape();
  ...
  texture(endwall2);
  textureWrap(REPEAT);
  vertex(-3000,height,-4000,0,0);
  vertex(-3000,-2000,-4000,1,0);
  vertex(-3000/6,-2000,-4000,1,1);
  vertex(-3000/6,height,-4000,0,1);
  endShape();
